...
Nota que o IST tem um núcleo (fantástico) dedicado à mobilidade – o Núcleo de Mobilidade e Parcerias Internacionais (NMPI) – junto ao qual podes obter toda
a informação logística, bolsas, prazos de candidatura, regulamentos, etc. 
- Contactos: erasmus@tecnico.ulisboa.pt (Europa) e outsideeurope@tecnico.ulisboa.pt (fora da Europa).

## Documentação
Overview do processo: aqui
Procedimentos para preenchimento dos documentos iniciais (PLA, LA e PEI): aqui
